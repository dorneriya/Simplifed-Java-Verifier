...
import oop.ex6.firstpass.*;
import oop.ex6.firstpass.classifylines.*;
import oop.ex6.secondPass.SecondPasser;
import oop.ex6.symbolTables.*;

import java.io.*;

/**
 * the main class that runs the sjava compiler.
 */
public class Sjavac {
	...
	/**
	 * the main method - gets a file path and prints out the result of weather it was "compiled" correctly
	 * or not.
